...
class Feedly {
     ...
     *                                           to $_SESSION or not
     */
    public function __construct($sandbox=FALSE, $storeAccessTokenToSession=FALSE) {
     ...
     * @return json   Response from the server
     */
    public function searchFeeds($q, $n=NULL,$l=NULL, $token=NULL) {
    ...
    public function getEntries ($entry ,$token=NULL){

        return $this->ExecGetRequest('/v3/entries/' . urlencode($entry),NULL,$token);
    }
}
